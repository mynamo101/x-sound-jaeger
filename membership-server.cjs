...
const createTables = () => {
  ...
  db.query(`
    CREATE TABLE IF NOT EXISTS users (
      ...
      tier ENUM('Free', 'Starter', 'Explorer', 'Creator') DEFAULT 'Free',
  ...
  db.query(`
    CREATE TABLE IF NOT EXISTS protected_files (
      ...
      required_tier ENUM('Free', 'Starter', 'Explorer', 'Creator') DEFAULT 'Starter',
      created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
    )
  `);
  ...
  db.query(`
    ...
    MODIFY COLUMN required_tier ENUM('Free', 'Starter', 'Explorer', 'Creator') DEFAULT 'Starter'
  `, (err) => {
...
function handleSubscriptionActivated(subscription) {
  const planIdToTier = {
    ...
    'P-5VY34435YG791411WNBIPG6A': 'Explorer',
    'P-658069381H438834BNBIPIDA': 'Creator'
  };
